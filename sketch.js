...
var knifeImage, fruit1, fruit2 ,fruit3, fruit4, monsterImage, gameOverImage, swoosh, over;
...
function Monster(){
  if(World.frameCount%200===0){
    ...
    monster.velocityX = -8-Math.floor(score/10);
...
function fruits(){
  if(World.frameCount%80===0){
    ...
    fruit.velocityX=-7-Math.floor(score/4);
    }
    else {
      if(position==2) {
      fruit.x=0;
